...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("Salva") action Skip() alternate Skip(fast=True, confirm=True)
...
screen preferences():
    ...
    use game_menu(_("Preferenze"), scroll="viewport"):
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    ...
                    label _("Avanza automaticamente")
